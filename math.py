...
print('The rounded value of pi is:', round(pi, 4)) # round to the 4th number
...
# Beware that these special numbers propgate with errors
print('pos_inf * x =', pos_inf * x) # infinity
