...
print(sub_text + sub_text)
print('_' * 40) # prints underscore 40 times
print('len(sub_text) returns', len(sub_text)) # length function how long is string
...
print('why_1.index("e", 3, 10) returns', why_1.index('e', 3, 18))
...
csv = 'a,b,c'
print('csv.split(",") returns', csv.split(",")) # split method
print('",".join(["a", "b", "c"]) returns', ",".join(["a", "b", "c"]))
print('sub_text.isalpha() returns', sub_text.isalpha()) # is all alphabetical
print('sub_text.isdigit() returns', sub_text.isdigit()) # is it a number
# end
