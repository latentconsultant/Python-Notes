# sequence bytes class

# The bytes class provides an immutable sequence
# Values must be integers from 0-255 to represent a byte

bytes_literal = b'Copyright \xc2\xa9'# b for bytes, hex xc2
print('bytes_literal =', bytes_literal)
print('bytes_literal.decode() ->', bytes_literal.decode()) # copyright sign hex
...
print('bytes_encoded.count(0x54) ->', bytes_encoded.count(0x54)) # hex 54 above
